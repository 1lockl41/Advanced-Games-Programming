...
float g_clear_colour[4] = { 0.1f, 0.5f,0.5f,1.0f };
...
void RenderFrame(void)
{
	...
	//else
	//{
	//	g_clear_colour[0] += 0.0001;
	//}

	//if (g_clear_colour[1] <= 0.0f)
	//{
	//	g_clear_colour[1] = 1.0f;
	//}
	//else
	//{
	//	g_clear_colour[1] -= 0.0001;
	//}
